/*
The following file replaces the following arduino methods with serial messages that communicate with the simulator:
- pinMode
- digitalRead
- digitalWrite
- analogRead
...
The file should be in the same folder as your arduino-sketch.ino file and be included at the top of the file with the following line:
